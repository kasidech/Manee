...
namespace MvcApplication2.Models
{
    public partial class DeliveryNote1
    {
        ...
        public virtual ICollection<NoteLineItem1> NoteLineItems
        {
            get
            {
                if (_noteLineItems == null)
                {
                    var newCollection = new FixupCollection<NoteLineItem1>();
            ...
            set
            {
                ...
                {
                    var previousValue = _noteLineItems as FixupCollection<NoteLineItem1>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupNoteLineItems;
                    }
                    _noteLineItems = value;
                    var newValue = value as FixupCollection<NoteLineItem1>;
                    if (newValue != null)
                    {
        ...
        private ICollection<NoteLineItem1> _noteLineItems;
        ...
        private void FixupNoteLineItems(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (NoteLineItem1 item in e.NewItems)
                {
            ...
            if (e.OldItems != null)
            {
                foreach (NoteLineItem1 item in e.OldItems)
                {
