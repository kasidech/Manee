...
namespace Manee.INV.Services {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class SampleWorkFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SampleWorkFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SampleWorkFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(SampleWorkFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SampleWorkFlow.g.xaml") || resource.Equals("SampleWorkFlow.g.xaml"))) {
                    return resource;
                }
            }
